...
@section('backContent')
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Liste des zones</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @foreach ($zones as $zone)
                                        <tr>
                                            ...
                                            <td style="text-align: center">{{ $zone->nom }}</td>
                                            <td style="text-align: center">
                                                <button type="button" onclick="deleteData({{ $zone->id }})"
                                                    class="btn btn-danger btn-sm waves-effect waves-light"
                                                    data-toggle="modal" data-target="#modalConfirmDeletes">
                                                    <i class="fa fa-trash"></i> Supprimer
                                                </button>
                                                <a href="{{ route('admin.zone.show', [($id = $zone->id)]) }}">
                                                    <button type="button"
                            ...
                            {!! $zones->withQueryString()->links('pagination::bootstrap-5') !!}
        ...
        <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-header d-flex justify-content-center">
                    <p class="heading">Vous êtes sûr de supprimer cette zone ?</p>
                </div>
    ...
    <script>
        function deleteData(id) {
            var id = id;
            var url = '{{ route('admin.zone.delete', ':id') }}';
