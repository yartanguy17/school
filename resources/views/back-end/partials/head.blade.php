...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('back-end/assets/vendor/charts/chartist-bundle/chartist.css') }}">
    <link rel="stylesheet" href="{{ asset('back-end/assets/vendor/charts/morris-bundle/morris.css') }}">
    <link rel="stylesheet"
